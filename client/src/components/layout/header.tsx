        ...
        <div className="flex justify-between items-center py-3">
          <div className="flex items-center ml-6">
            <a href="https://www.diversiteartistique.org" target="_blank" rel="noopener noreferrer" className="flex items-center">
              <img src="https://yorkiuccnxoyyzrliung.supabase.co/storage/v1/object/public/image/dam-bottin-logo.png" alt="Diversité Artistique Montréal - Bottin des Artistes" className="h-12 w-auto object-contain" />
            </a>
          </div>
